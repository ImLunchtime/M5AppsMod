...
#define THEME_COLOR_BG (uint32_t)(0x101010)
#define THEME_COLOR_BG_DARK (uint32_t)(0x101010)
#define THEME_COLOR_SYSTEM_BAR (uint32_t)(0x3F3F3F) //(0x99FF00)
#define THEME_COLOR_SYSTEM_BAR_TEXT TFT_BLACK
#define THEME_COLOR_KB_BAR (uint32_t)(0x3A3A3A)
#define THEME_COLOR_KB_BAR_ICON_BG TFT_DARKGREY
#define THEME_COLOR_KB_BAR_ICON_TEXT TFT_WHITE
#define THEME_COLOR_ICON (uint32_t)(0x555555)
